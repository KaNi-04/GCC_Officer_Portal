...
public class Petition {
    ...
    @JsonCreator
    public Petition(
            @JsonProperty("petitionId") Long petitionId,
            @JsonProperty("mtmEvents") MtmEvents mtmEvents,
            @JsonProperty("petitionNumber") String petitionNumber,
            @JsonProperty("petitionerName") String petitionerName,
            @JsonProperty("petitionerMobile") String petitionerMobile,
            @JsonProperty("petitionerComplaint") String petitionerComplaint,
            @JsonProperty("petitionerAddress") String petitionerAddress,
            @JsonProperty("petitionerPincode") String petitionerPincode,
            @JsonProperty("petitionerNatureOfComplaint") String petitionerNatureOfComplaint,
            ...
            @JsonProperty("petitionerComplaint_txt") String petitionerComplaint_txt
    ) {
	...
	// Define the nested classes for mtmEvents
