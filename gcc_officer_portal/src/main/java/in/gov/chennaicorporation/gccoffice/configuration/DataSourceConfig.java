...
public class DataSourceConfig {
    ...
    @EnableJpaRepositories(
        ...
        basePackages = {"in.gov.chennaicorporation.gccoffice.repository"})
...
/*
        ...
        public JdbcTemplate mysqlAppJdbcTemplate(@Qualifier("mysqlAppDataSource") DataSource dataSource) {
...
*/
    ...
    @EnableJpaRepositories(
        ...
        basePackages = {"in.gov.chennaicorporation.gccoffice.taxcollection.repository"})
    public static class MysqlTaxCollectionDataSourceConfig {
        ...
        public PlatformTransactionManager taxTransactionManager(@Qualifier("taxEntityManagerFactory") EntityManagerFactory taxEntityManagerFactory) {
