...
@RequestMapping("/gcc/callcenterqaqccomplaintsregistration") 
@Controller("callCenterQaQcComplaintsRegistrationController")
public class QaqcPgrComplaintsMainController {
	
	@Autowired
	private QaqcAgentsService agentsService;
	
	@GetMapping("/pgrcomplaint")
	public String viewPGRpage(Model model) {
	    ...
	    return "modules/callcenterqaqc/pgrcomplaints";
	}
