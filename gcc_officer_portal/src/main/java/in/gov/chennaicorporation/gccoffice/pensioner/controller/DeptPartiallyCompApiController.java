...
@RequestMapping("gcc/api/department/partial")
@RestController
public class DeptPartiallyCompApiController {
    ...
    public ResponseEntity<String> updateEmployeeDetails(@RequestBody Map<String, Object> requestData) {
        try {
            ...
            boolean isSaved = deptPartiallyCompleteService.updateEntryCompletedDetails(requestData);
            ...
            if (isSaved) {
            	...
            	boolean updated=deptPartiallyCompleteService.saveHistory(emp_details,zone_benefits,pension_benefits,filemovedby);
