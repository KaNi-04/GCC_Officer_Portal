...
public class ReportService {
	...
	public Map<String, Object> getlistdata(String ref) {
		...
		String sql = "SELECT id.*, um.name AS inspector_name, " +
		...
		String reSql = "SELECT r.id AS reins_id, r.committee_action, r.remarks AS reins_remarks, " +
	...
	public List<String> getPendingRefIds(
		...
		switch (type.toUpperCase()) {
			...
			case "WITHDRAW":
				baseSql = "SELECT rd.ref_id FROM reg_details rd " +
						"WHERE rd.zone=? AND rd.is_withdraw=1";
				break;
