...
@RequestMapping("gcc/api/callcenterqaqc/agent/publicfollowupcalls")  
@RestController
public class PublicFollowUpController {
...
//			System.out.println("updated_agent: " + updated_agent);
	...
	@GetMapping("/getpubsubmittedcalls")
	public List<Map<String, Object>> getFollowupSubmitDetails(@RequestParam int userId)
	{
		return publicService.getFollowupSubmitDetails(userId);
	}
}
